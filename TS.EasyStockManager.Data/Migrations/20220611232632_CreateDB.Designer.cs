...
namespace TS.EasyStockManager.Data.Migrations
{
    ...
    [Migration("20220611232632_CreateDB")]
            ...
            modelBuilder.Entity("TS.EasyStockManager.Data.Entity.Product", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1,
                            Barcode = "EX01",
                            CreateDate = new DateTime(2022, 6, 12, 2, 26, 32, 202, DateTimeKind.Local).AddTicks(3080),
                            Price = 1m,
            ...
            modelBuilder.Entity("TS.EasyStockManager.Data.Entity.Store", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            CreateDate = new DateTime(2022, 6, 12, 2, 26, 32, 201, DateTimeKind.Local).AddTicks(7380),
                            StoreCode = "EX01",
            ...
            modelBuilder.Entity("TS.EasyStockManager.Data.Entity.TransactionType", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            CreateDate = new DateTime(2022, 6, 12, 2, 26, 32, 174, DateTimeKind.Local).AddTicks(3550),
                            TransactionTypeName = "Stock Receipt"
                        },
                        new
                        {
                            Id = 2,
                            CreateDate = new DateTime(2022, 6, 12, 2, 26, 32, 180, DateTimeKind.Local).AddTicks(3060),
                            TransactionTypeName = "Stock Out"
                        },
                        new
                        {
                            Id = 3,
                            CreateDate = new DateTime(2022, 6, 12, 2, 26, 32, 180, DateTimeKind.Local).AddTicks(3090),
            ...
            modelBuilder.Entity("TS.EasyStockManager.Data.Entity.UnitOfMeasure", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            CreateDate = new DateTime(2022, 6, 12, 2, 26, 32, 182, DateTimeKind.Local).AddTicks(2390),
                            Isocode = "pc",
                        ...
                        {
                            Id = 2,
                            CreateDate = new DateTime(2022, 6, 12, 2, 26, 32, 182, DateTimeKind.Local).AddTicks(2600),
                            Isocode = "kg",
                        ...
                        {
                            Id = 3,
                            CreateDate = new DateTime(2022, 6, 12, 2, 26, 32, 182, DateTimeKind.Local).AddTicks(2680),
                            Isocode = "m",
            ...
            modelBuilder.Entity("TS.EasyStockManager.Data.Entity.User", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            CreateDate = new DateTime(2022, 6, 12, 2, 26, 32, 201, DateTimeKind.Local).AddTicks(1870),

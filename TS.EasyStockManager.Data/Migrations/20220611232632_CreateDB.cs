    ...
    public partial class CreateDB : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[] { 1, new DateTime(2022, 6, 12, 2, 26, 32, 201, DateTimeKind.Local).AddTicks(7380), "EX01", "Example Store" });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, new DateTime(2022, 6, 12, 2, 26, 32, 174, DateTimeKind.Local).AddTicks(3550), "Stock Receipt" },
                    { 2, new DateTime(2022, 6, 12, 2, 26, 32, 180, DateTimeKind.Local).AddTicks(3060), "Stock Out" },
                    { 3, new DateTime(2022, 6, 12, 2, 26, 32, 180, DateTimeKind.Local).AddTicks(3090), "Transfer" }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, new DateTime(2022, 6, 12, 2, 26, 32, 182, DateTimeKind.Local).AddTicks(2390), "pc", "Piece" },
                    { 2, new DateTime(2022, 6, 12, 2, 26, 32, 182, DateTimeKind.Local).AddTicks(2600), "kg", "Kilogram" },
                    { 3, new DateTime(2022, 6, 12, 2, 26, 32, 182, DateTimeKind.Local).AddTicks(2680), "m", "Meter" }
                });

            migrationBuilder.InsertData(
                table: "User",
                columns: new[] { "Id", "CreateDate", "Email", "Name", "Password", "Surname" },
                values: new object[] { 1, new DateTime(2022, 6, 12, 2, 26, 32, 201, DateTimeKind.Local).AddTicks(1870), "admin@admin.com", "Admin", "827ccb0eea8a706c4c34a16891f84e7b", "Admin" });

            migrationBuilder.InsertData(
                table: "Product",
                columns: new[] { "Id", "Barcode", "CategoryId", "CreateDate", "Description", "Image", "Price", "ProductName", "UnitOfMeasureId" },
                values: new object[] { 1, "EX01", null, new DateTime(2022, 6, 12, 2, 26, 32, 202, DateTimeKind.Local).AddTicks(3080), null, null, 1m, "Example Product", 1 });
